...
message(STATUS "lane_detector: 0 messages, 0 services")
...
if(TARGET geometry_msgs_generate_messages_eus)
  add_dependencies(lane_detector_generate_messages_eus geometry_msgs_generate_messages_eus)
endif()
...
if(TARGET geometry_msgs_generate_messages_nodejs)
  add_dependencies(lane_detector_generate_messages_nodejs geometry_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lane_detector)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lane_detector\")")
  # install generated code
  install(
